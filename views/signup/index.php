...
<div style="width: 400px;height:350px;position: relative;margin-top:150px;background-color: #D6E6F2;border-radius: 10px;">
  <h1 style="text-align: center;padding-top:20px;">Sign Up</h1>
    ...
    <div style="text-align:center;margin-top: 50px;">
        ...
        <a onclick="javascript:signUp();"><button class="w-btn w-btn-blue">회원가입</button></a>
    </div>
  </div>
</body>
</html>
<?php
    $check = file_exists($_SERVER["DOCUMENT_ROOT"].'/views/signup/jquery.php');
    if ($check) {
        ob_start();

        include $_SERVER["DOCUMENT_ROOT"].'/views/signup/jquery.php';
