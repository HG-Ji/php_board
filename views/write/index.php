...
<div style="width: 1000px;position: relative;margin-top:50px;">
  <h1>글쓰기</h1>
    ...
    <div style="margin-top:20px;margin-left:50px;">
        <label>제목</label>
        <input type="text" style="width:95%;height:20px;border-radius: 5px;" id="title"/>
    </div>
    <div style="margin-top:20px;margin-left:50px;">
        <label style="vertical-align: top;">내용</label>
        <textarea style="width:95%;height:450px;border-radius: 5px;resize: none;" id="content"></textarea>
    </div>
